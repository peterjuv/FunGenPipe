...
annKeggEntrez <- function(organism="mmu", annPackage="org.Mm.eg.db") {
    ...
    annKeggrestOrg$Symbols <- base::sapply(base::sapply(keggPathOrg2EntrezIDs[rownames(annKeggrestOrg)], function(entrezIDs) {unlist(BiocGenerics::mget(entrezIDs, annPckgEnv, ifnotfound=NA))}), paste, collapse=";")
